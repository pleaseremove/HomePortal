...
<div id="content">
	...
	<p style="margin: 10px 2%;">
		<a data-selection="money-utils" href="money/statistics/account_breakdown">Account breakdown</a>
	</p>
	
	<p style="margin: 10px 2%;">
		<a data-selection="money-utils" href="money/statistics/category_spending">Category Spending</a>
	</p>
