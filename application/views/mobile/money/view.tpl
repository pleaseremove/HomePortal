			  ...
			  <div class="ui-body ui-body-a">
			    <div data-role="fieldcontain">
					...
					<div data-role="fieldcontain">
						...
						<input type="tel" name="amount[]" id="amount" autocomplete="off" value="{$t->amount}" />
					</div>
