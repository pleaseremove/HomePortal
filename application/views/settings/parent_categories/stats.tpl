...
<div id="content">
	...
	<form action="money/categories/stats/7">
		<p style="margin: 10px 2%;">
			...
			<input class="date_picker" name="date_range_s" value="{$smarty.post.date_range_s}" style="width:70px;" />
			<label style="margin-left:10px">End Date</label>
			<input class="date_picker" name="date_range_e" value="{$smarty.post.date_range_e}" style="width:70px;" />
