...
class CI_DB_sqlsrv_driver extends CI_DB {
	...
	function db_connect($pooling = false)
	{
		...
		// SF 29/05/2012 - Set date for connection.
		...
		if ( ! $conn)
		{
			...
			$this->conn_id =& $conn;
			$this->_execute('SET DATEFORMAT '.($this->dateloca ? $this->dateloca : 'YMD'));
		}
	...
	function _execute($sql)
	{
		...
		//sf+ck 2012/03/19 - to obtain affected rows you cant use a scrollable cursor
